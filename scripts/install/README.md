...
- `install-ansible-awx.sh` -> Installs Ansible AWX with Docker on multiple distros (CentOS 7+, RHEL 8+, Ubuntu/Debian 20+). Configurable AWX version, admin credentials, and Docker Compose version.
